...
public class MessageAdapter_receive extends ArrayAdapter<Message> {

    private int resourceId;

    public MessageAdapter_receive(Context context, int textViewResourceId, List<Message> objects) {
